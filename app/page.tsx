...
export default function HomePage() {
  useEffect(() => {
    // Hide Spline branding/watermark after component loads
    const hideSplineBranding = () => {
      // Hide branding for all spline-viewer elements
      const splineViewers = document.querySelectorAll('spline-viewer');
      splineViewers.forEach((splineViewer) => {
        // Hide any links or buttons inside spline-viewer
        ...
        // Also try to hide via shadow DOM if accessible
        try {
    ...
    // Try immediately and after delays to catch all instances
    hideSplineBranding();
  ...
  return (
    <div className="bg-background text-gray-300 font-sans antialiased selection:bg-green-900 selection:text-green-100 relative min-h-screen">
      ...
      <section className="md:pt-48 md:pb-32 overflow-hidden pt-32 pb-20 relative">
        {/* Spline Background Integration - Only in Hero Section */}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex justify-center gap-8 mb-12">
            <div className="flex flex-col items-center gap-2 group cursor-pointer">
              <div className="p-3 rounded-xl bg-card/80 backdrop-blur border border-white/10 group-hover:border-white/20 group-hover:shadow-[0_0_20px_-5px_rgba(255,255,255,0.1)] transition-all">
                {/* file-json */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[500px]">
              ...
              <div className="p-6 md:p-8 bg-surface/80 backdrop-blur-md flex flex-col justify-center">
                ...
                <div className="space-y-3">
                  ...
                  <label className="cursor-pointer group block relative">
                    {/* In React, checked needs to be controlled; use defaultChecked for static demo */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
            <div className="xl:col-span-4 flex flex-col justify-center">
              ...
              <button className="w-fit bg-white text-black px-6 py-3 rounded-lg font-medium hover:bg-gray-200 transition-colors flex items-center gap-2">
                Enter Practice Mode
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
          ...
          <div className="relative">
            ...
            <div className="bg-gradient-to-b from-white/5 to-white/[0.02] border border-white/10 rounded-2xl p-8 md:p-12 shadow-2xl backdrop-blur-sm">
              ...
              <div className="flex justify-center mb-8">
                <button className="bg-white text-black px-8 py-3.5 rounded-full font-medium hover:bg-gray-200 transition-colors shadow-lg">
                  Get started now
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 bg-white rounded flex items-center justify-center">
              <span className="text-black font-bold text-[10px]">L</span>
            </div>
            <span className="text-sm font-medium text-gray-400">GetLowLevel © 2024</span>
          </div>
